              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/"
                      className="flex align-center items-start mb-4 inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                  ...
                  <li>
                    <a
                      ...
                      className="flex align-center items-start mb-4 inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                      <FaEnvelope /> &nbsp; Email (fake): info@melodiousacademy.com
                    </a>
                  </li>
                </ul>
              </div>
